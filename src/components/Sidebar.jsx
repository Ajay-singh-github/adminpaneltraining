...
function Sidebar() {
    ...
    const handleNavigate=()=>{
        alert("HELLO IT IS READY TO NAVIGATE")
    }
    ...
    return (
        <div className='w-[15%]  h-[100vh] bg-zinc-900 flex flex-col gap-2.5'>
            ...
            <div onClick={()=>handleNavigate()} className='w-full h-[35px] hover:bg-zinc-700  cursor-pointer flex items-center pl-10 gap-3 text-white font-mono'><ChartBarStacked size={20} />Category</div>
